...
namespace Телефонный_справочник_организации {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(string ФИО, string Должность, string Номер_телефона, string Email) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string ФИО {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'ФИО\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string Номер_телефона {
                get {
                    try {
                        return ((string)(this[this.tableTable.Номер_телефонаColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер телефона\' в таблице \'Table\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.Номер_телефонаColumn] = value;
                }
            }
            ...
            public bool IsНомер_телефонаNull() {
                return this.IsNull(this.tableTable.Номер_телефонаColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetНомер_телефонаNull() {
                this[this.tableTable.Номер_телефонаColumn] = global::System.Convert.DBNull;
            }
...
namespace Телефонный_справочник_организации.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([ФИО], [Должность], [Номер телефона], [Email]) VALUES " +
                "(@ФИО, @Должность, @Номер_телефона, @Email)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Телефонный_справочник_организации.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ФИО, Должность, [Номер телефона], Email FROM dbo.[Table]";
        ...
        public virtual int Insert(string ФИО, string Должность, string Номер_телефона, string Email) {
            if ((ФИО == null)) {
